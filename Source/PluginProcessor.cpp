    ...
    for (int i = 0; i < mySynth.getNumVoices(); i++) {
        ...
        if ((myVoice = dynamic_cast<SynthVoice*>(mySynth.getVoice(i)))){
            ...
            // if initialisation phase is done
                ...
                voiceValue = (float*)tree.getRawParameterValue("voicesSliderID");
                voiceAmountValue = (float*)tree.getRawParameterValue("voiceAmountSliderID");
            }
            ...
            if (*voiceValue == 1){
                // osc
                myVoice->getOscPitchOffsetVoices((float*)tree.getRawParameterValue(osc1AmountOfOscVoicesIDS[0]), (float*)tree.getRawParameterValue(osc1VoicesPitchOffsetIDS[0]));
            }
            else if (*voiceValue == 2){
                // osc
                myVoice->getOscPitchOffsetVoices((float*)tree.getRawParameterValue(osc1AmountOfOscVoicesIDS[1]), (float*)tree.getRawParameterValue(osc1VoicesPitchOffsetIDS[1]));
            }
            else {
                // osc
                myVoice->getOscPitchOffsetVoices((float*)tree.getRawParameterValue(osc1AmountOfOscVoicesIDS[2]), (float*)tree.getRawParameterValue(osc1VoicesPitchOffsetIDS[2]));
            }
            ...
            // osc
            float* oscMenuSelections[4] = {(float*)tree.getRawParameterValue(oscMenus[vn][0]), (float*)tree.getRawParameterValue(oscMenus[vn][1]), (float*)tree.getRawParameterValue(oscMenus[vn][2]), (float*)tree.getRawParameterValue(oscMenus[vn][3])};
            float* oscDetuneSelections[4] = {(float*)tree.getRawParameterValue(oscDetunes[vn][0]), (float*)tree.getRawParameterValue(oscDetunes[vn][1]), (float*)tree.getRawParameterValue(oscDetunes[vn][2]), (float*)tree.getRawParameterValue(oscDetunes[vn][3])};
            float* oscGainSelections[4] = {(float*)tree.getRawParameterValue(oscGains[vn][0]), (float*)tree.getRawParameterValue(oscGains[vn][1]), (float*)tree.getRawParameterValue(oscGains[vn][2]), (float*)tree.getRawParameterValue(oscGains[vn][3])};
            myVoice->getAllOsc1Parameters(oscMenuSelections, oscDetuneSelections, oscGainSelections);
            
            // env2
            myVoice->getEnv2ParametersDetuneV((float*)tree.getRawParameterValue(env2AttackSlidersP[vn][0]), (float*)tree.getRawParameterValue(env2ReleaseSlidersP[vn][0]), (float*)tree.getRawParameterValue(env2DopplerButtonsP[vn][0]), (float*)tree.getRawParameterValue(env2OnOffButtonsP[vn][0]), (float*)tree.getRawParameterValue(env2DelaySlidersP[vn][0]), (float*)tree.getRawParameterValue(env2ForwardsButtonsP[vn][0]), (float*)tree.getRawParameterValue(env2SustainButtonsP[vn][0]));
            myVoice->getEnv2ParametersOVDV((float*)tree.getRawParameterValue(env2AttackSlidersP[vn][1]), (float*)tree.getRawParameterValue(env2ReleaseSlidersP[vn][1]), (float*)tree.getRawParameterValue(env2DopplerButtonsP[vn][1]), (float*)tree.getRawParameterValue(env2OnOffButtonsP[vn][1]), (float*)tree.getRawParameterValue(env2DelaySlidersP[vn][1]), (float*)tree.getRawParameterValue(env2ForwardsButtonsP[vn][1]), (float*)tree.getRawParameterValue(env2SustainButtonsP[vn][1]));
            myVoice->getEnv2ParametersPanV((float*)tree.getRawParameterValue(env2AttackSlidersP[vn][2]), (float*)tree.getRawParameterValue(env2ReleaseSlidersP[vn][2]), (float*)tree.getRawParameterValue(env2DopplerButtonsP[vn][2]), (float*)tree.getRawParameterValue(env2OnOffButtonsP[vn][2]), (float*)tree.getRawParameterValue(env2DelaySlidersP[vn][2]), (float*)tree.getRawParameterValue(env2ForwardsButtonsP[vn][2]), (float*)tree.getRawParameterValue(env2SustainButtonsP[vn][2]));
            myVoice->getEnv2ParametersGainV((float*)tree.getRawParameterValue(env2AttackSlidersP[vn][3]), (float*)tree.getRawParameterValue(env2ReleaseSlidersP[vn][3]), (float*)tree.getRawParameterValue(env2DopplerButtonsP[vn][3]), (float*)tree.getRawParameterValue(env2OnOffButtonsP[vn][3]), (float*)tree.getRawParameterValue(env2DelaySlidersP[vn][3]), (float*)tree.getRawParameterValue(env2ForwardsButtonsP[vn][3]));

            // GENERAL VALUES
            // env1
            myVoice->getEnv1Parameters((float*)tree.getRawParameterValue("env1MenuID"), &masterAttack, &masterRelease, (float*)tree.getRawParameterValue("env1SmoothOnOffButtonID"), (float*)tree.getRawParameterValue("env1SmoothAmountSliderID"));
            
            // create arrays to give to voices
            float* env1Attacks[6] = {(float*)tree.getRawParameterValue("env1PointSlider1ID"), (float*)tree.getRawParameterValue("env1PointSlider2ID"), (float*)tree.getRawParameterValue("env1PointSlider3ID"), (float*)tree.getRawParameterValue("env1PointSlider4ID"), (float*)tree.getRawParameterValue("env1PointSlider5ID"),(float*)tree.getRawParameterValue("env1PointSlider6ID")};
            float* env1Releases [6] = {(float*)tree.getRawParameterValue("env1PointReleaseSlider1ID"), (float*)tree.getRawParameterValue("env1PointReleaseSlider2ID"), (float*)tree.getRawParameterValue("env1PointReleaseSlider3ID"), (float*)tree.getRawParameterValue("env1PointReleaseSlider4ID"), (float*)tree.getRawParameterValue("env1PointReleaseSlider5ID"),(float*)tree.getRawParameterValue("env1PointReleaseSlider6ID")};
            ...
            // env 3
            myVoice->getEnv2ParametersLFO( (float*)tree.getRawParameterValue(env3AttackSlidersP[0]), (float*)tree.getRawParameterValue(env3ReleaseSliderP[0]), (float*)tree.getRawParameterValue(env3DopplerButtonsP[0]), (float*)tree.getRawParameterValue(env3OnOffButtonsP[0]), (float*)tree.getRawParameterValue(env3DelaySliderP[0]), (float*)tree.getRawParameterValue(env3ForwardsButtonsP[0]), LFORange, (float*)tree.getRawParameterValue(env3SustainButtonsP[0]));
            myVoice->getEnv2ParametersPan( (float*)tree.getRawParameterValue(env3AttackSlidersP[2]), (float*)tree.getRawParameterValue(env3ReleaseSliderP[2]), (float*)tree.getRawParameterValue(env3DopplerButtonsP[2]), (float*)tree.getRawParameterValue(env3OnOffButtonsP[2]), (float*)tree.getRawParameterValue(env3DelaySliderP[2]), (float*)tree.getRawParameterValue(env3ForwardsButtonsP[2]), (float*)tree.getRawParameterValue(env3SustainButtonsP[2]));
            myVoice->getEnv2ParametersDetune((float*)tree.getRawParameterValue(env3AttackSlidersP[5]), (float*)tree.getRawParameterValue(env3ReleaseSliderP[5]), (float*)tree.getRawParameterValue(env3DopplerButtonsP[5]), (float*)tree.getRawParameterValue(env3OnOffButtonsP[5]), (float*)tree.getRawParameterValue(env3DelaySliderP[5]), (float*)tree.getRawParameterValue(env3ForwardsButtonsP[5]), (float*)tree.getRawParameterValue(env3SustainButtonsP[5]));
            
            // effects
            myVoice->getDistortionParameters((float*)tree.getRawParameterValue("distortionOnOffButtonID"), (float*)tree.getRawParameterValue("distortionDriveSliderID"), (float*)tree.getRawParameterValue("distortionRangeSliderID"), (float*)tree.getRawParameterValue("distortionBlendSliderID"), (float*)tree.getRawParameterValue("distortionGainSliderID"), (float*)tree.getRawParameterValue("distortionMenuID"));
            // master
            // create arrays to give to voices
            float* masterVoiceGains[3] = {(float*)tree.getRawParameterValue(voiceMixSliderIDsP[0]), (float*)tree.getRawParameterValue(voiceMixSliderIDsP[1]), (float*)tree.getRawParameterValue(voiceMixSliderIDsP[2])};
            float* masterVoiceMutes[3] = {(float*)tree.getRawParameterValue(voiceMuteButtonIDsP[0]), (float*)tree.getRawParameterValue(voiceMuteButtonIDsP[1]), (float*)tree.getRawParameterValue(voiceMuteButtonIDsP[2])};
            float* masterVoiceSolos[3] = {(float*)tree.getRawParameterValue(voiceSoloButtonIDsP[0]), (float*)tree.getRawParameterValue(voiceSoloButtonIDsP[1]), (float*)tree.getRawParameterValue(voiceSoloButtonIDsP[2])};
            float* masterVoicePans[3]  = {(float*)tree.getRawParameterValue(voicePanSliderIDsP[0]), (float*)tree.getRawParameterValue(voicePanSliderIDsP[1]), (float*)tree.getRawParameterValue(voicePanSliderIDsP[2])};
            
            myVoice->getMasterParameters2((float*)tree.getRawParameterValue("masterGainSliderID"), (float*)tree.getRawParameterValue("masterPanSliderID"), masterVoiceGains, masterVoiceMutes, masterVoiceSolos, masterVoicePans);
