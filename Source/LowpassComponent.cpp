...
{
    processor.initialiseTreeMember("lowpassCutoffSliderID", frequencyRange, new AdaptableParameterVariable(processor.parameters.lowpassCutoff));
    processor.initialiseTreeMember("lowpassResonanceSliderID", resonanceRange, new AdaptableParameterVariable(processor.parameters.lowpassResonance));
